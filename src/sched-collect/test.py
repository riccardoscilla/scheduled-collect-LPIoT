...
# Script used to test:
#     n_test      number of tests to run
#     folder      where to put the results
#     run tests in cooja and compute the results with parse_stats.py
#     then aggeregate the results and compute the metrics and plots

n_test = 3
folder = "test_udgm_distLoss_50_changeP/"
# folder = "test_mrm_20_changeP/"

...
def getValues(x, p):
    ...
    for i in x:
        folder = "results/distLoss/test_udgm_distLoss_"+p+"_changeP/"
...
# print("\nDC 50")
# for i in range(8):
#     print(str(round(dc50[i],2))+" $\pm$ "+str(round(dc50_error[i],2)))
...
plt.show()
fig.savefig('images/distLoss.png')